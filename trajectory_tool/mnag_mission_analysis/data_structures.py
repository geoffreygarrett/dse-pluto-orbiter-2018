...
flyby_guess = namedtuple('flyby_guess', 'v_i, v_inf_i, v_planet_i, ecc_i, sma_i, v_p_i, r_p, r_p_dv, a_req,'
                                        'v_f, v_inf_f, v_planet_f, ecc_f, sma_f, v_p_f, argp, inc, raan, t_i, t_f')

flyby_refined = namedtuple('flyby_guess', 'v_i, v_inf_i, v_planet_i, ecc_i, sma_i, v_p_i, r_p, r_p_dv, error, a_req'
                                          'v_f, v_inf_f, v_planet_f, ecc_f, sma_f, v_p_f, argp, inc, raan, t_i, t_f')
